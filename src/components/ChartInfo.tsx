...
export const ShootingTypeChartInfo = {
  ...
  thumbnail: "picShootingTypeChart.png",
};
...
export const TypesByYearChartInfo = {
  ...
  thumbnail: "/picTypesByYearChart.png",
};
export const SimpleBarChartInfo = {
  ...
  thumbnail: "/picSimpleBarChart.png",
};
